...
function AllFeedback() {
  ...
  useEffect(() => {
    console.log(useremail); // Trigger search with the updated responded value
  }, [useremail]);
  useEffect(() => {
  ...
  function Item({ fid, isrespond, eid }) {
    if (isrespond == 1) {
      return;
    }
    return <IconButton
                  ...
                  >
                    ...
                    <TableCell>
                      <Item isrespond={feedback.responded}
                        fid={feedback.id} eid={feedback.useremail}/>
